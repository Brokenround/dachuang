...
def average_gradients(model):
    ...
    for name, param in model.named_parameters():
        try:
            # 使用dist.all_reduce对梯度进行求和，以便后续平均
